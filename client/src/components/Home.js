    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-6">
      <div className="bg-white shadow-lg rounded-xl p-6 w-full max-w-md text-center">
        ...
        <div className="space-y-3">
          <Link to="/summary" className="block bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700">
            View Client Summary
          </Link>

          <Link to="/entry" className="block bg-green-600 text-white px-6 py-3 rounded-lg hover:bg-green-700">
            Submit an Entry
          </Link>

          <a href={GOOGLE_SHEET_LINK} target="_blank" rel="noreferrer"
             className="block bg-gray-200 text-gray-800 px-6 py-3 rounded-lg hover:bg-gray-300">
            Open Google Sheet
          </a>
        </div>
      </div>
